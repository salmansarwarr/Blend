...
const Name = () => {
  ...
  const handlePinataUri = async () => {
    const metadata = {
      name,
      obj,
      thumbnail: "https://red-ready-marlin-412.mypinata.cloud/ipfs/QmNXTQ2CNmjn7o4vJK1V7Ch53zaHShaHci84NshuWaZhYt?_gl=1*1mbixbc*_ga*MTk0Mzk3OTkyNy4xNzAyMDYzMjky*_ga_5RMPXG14TE*MTcwMzE2NTI4MC45LjEuMTcwMzE2NTMyMy4xNy4wLjA."
    };
